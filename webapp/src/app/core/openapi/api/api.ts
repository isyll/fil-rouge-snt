...
export const APIS = [AnneeScolaireService, ClasseService, EtudiantService, FiliereService, InscriptionService, ModuleService, NiveauService, OuvertureService, ProfesseurService, SalleService];
