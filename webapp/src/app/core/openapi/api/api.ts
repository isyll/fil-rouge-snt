...
export const APIS = [AnneeScolaireService, ClasseService, CoursService, EtudiantService, FiliereService, InscriptionService, ModuleService, NiveauService, OuvertureService, ProfesseurService, SalleService];
