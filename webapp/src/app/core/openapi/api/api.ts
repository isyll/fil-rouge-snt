...
export const APIS = [AnneeScolaireService, ClasseService, CoursService, EtudiantService, FiliereService, InscriptionService, LoginCheckService, ModuleService, NiveauService, OuvertureService, ParamService, PresenceService, ProfesseurService, SalleService, SessionCoursService, UserService];
